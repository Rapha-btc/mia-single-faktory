;; - friedger inputs 10MIA (he wants to borrow against it?)
;; - then he airdrops the STX to the ccd13 (what's the contract?)
;; - at the same time he redeems it with 10M MIA
;; - then calls SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.mia-fair-faktory-v2 settle-offers 
;; - the STX stays in there to be called settle-offers until it's fully consumed by fair
