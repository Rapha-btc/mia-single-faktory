// verify-deployed.js
// SELF-VERIFYING stxer mainnet-fork harness against the LIVE mainnet trio
// (SPV9K21....mia-{pool,single,fair}-faktory, deployed 2026-07-03, Clarity 5).
// Same 43-check arc as verify-happy-path.js but with NO deploys -- it
// exercises the exact bytecode that is on-chain, including the pending
...
// NOTE: no deploys — this harness runs against the LIVE mainnet contracts
// (deployed 2026-07-03 at Clarity 5). Redeploying under SPV9K21 would hit
// InvalidStacksTransaction("Duplicate contract") and cascade nonces.
const plan = [];
...
// =====================================================================
// Act 1 -- par snapshot on the LIVE contracts (validates the pending
// mainnet initialize tx byte-for-byte)
// =====================================================================
