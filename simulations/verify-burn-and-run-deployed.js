// verify-burn-and-run-deployed.js
// Same scenario as verify-burn-and-run-full.js, but against the ALREADY
// DEPLOYED SPV9K21....mia-burn-and-run - no deploy step, so this exercises the
// exact bytecode fastpool will call on mainnet.
//
...
// NO deploy step: exercises the LIVE SPV9K21....mia-burn-and-run bytecode
// (deployed at burn 960,027, tx 0xb06bd4d5..., source sha256 68d9c6c6...).
...
async function main() {
  console.log("=== mia-burn-and-run -- DEPLOYED contract, fat treasury, 5 loops ===\n");
